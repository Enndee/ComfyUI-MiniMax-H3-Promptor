...
from .py.h3_promptor import H3_Promptor_Enndee
from .py.h3_vision_analyzer import H3_Vision_Analyzer_Enndee
from .py.h3_multimodal_promptor import H3_Multimodal_Promptor_Enndee

NODE_CLASS_MAPPINGS = {
    "H3_Promptor_Enndee": H3_Promptor_Enndee,
    "H3_Vision_Analyzer_Enndee": H3_Vision_Analyzer_Enndee,
    "H3_Multimodal_Promptor_Enndee": H3_Multimodal_Promptor_Enndee,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "H3_Promptor_Enndee": "MiniMax H3 Promptor (Enndee)",
